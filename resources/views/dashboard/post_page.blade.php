                ...
                <table class="table_design">
                    ...
                    @foreach($post as $meowpost)
                        <tr Class="td_deg">
                            ...
                            <td>{{$meowpost->Description}}</td>
                            <td>{{$meowpost->name}}</td>
                            <td>{{$meowpost->post_status}}</td>
                            <td>
                            <img class= "img_deg" src= "postimage/{{$meowpost->image}}">
                            </td>
                            <td>
                                <a href="{{url('delete_post',$meowpost->id)}}" class="btn btn-danger" onclick="return confirm('Are you sure to delete this?')">Delete</a>
                            </td>
                            <td>
                                <a href="{{url('edit_post',$meowpost->id)}}" class="btn btn-success" onclick="return confirm('Are you sure to update this?')">Edit</a>
                            </td>
                        </tr>
                    @endforeach
                </table>
